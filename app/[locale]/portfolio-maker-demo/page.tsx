...
export default async function PortfolioMakerDemoPage({
  ...
  // Full-bleed editor, same wrapper pattern as the real editor page. The
  // disclaimer banner is a layout-level sibling (sticky, non-dismissible) so
  // it persists across zone switches without EditorShell needing to know
  // about it.
  return (

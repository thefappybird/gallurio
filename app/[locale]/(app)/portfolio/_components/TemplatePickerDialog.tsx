              ...
              return (
                <li key={tpl.id}>
                  <button
                    ...
                    className={cn(
                      "flex h-full w-full flex-col gap-3 border p-3 text-start transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:opacity-50",
                      pending?.id === tpl.id

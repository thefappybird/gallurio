...
export function BrandingStepForm({ defaults }: { defaults: BrandingStepInput }) {
  ...
  async function handleFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (!file.type.startsWith("image/")) {
      setServerError("Logo must be an image.");
      return;
    }
    if (file.size > 5 * 1024 * 1024) {
      setServerError("Logo must be under 5 MB.");
      return;
    }
    setServerError(null);
    setUploading(true);
  ...
  return (
    <StepShell
      step="branding"
      title="Make it yours"
      description="Add a logo, pick your colors, and write a one-line tagline. You can change all of this later."
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
            ...
            <div className="flex gap-2">
              ...
              >
                {uploading ? (
                  ...
                  <>
                    <Upload className="mr-2 h-4 w-4" /> {logoUrl ? "Replace" : "Upload"}
                  </>
                )}
              </Button>
              {logoUrl && (
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <Input
            id="tagline"
            placeholder="Wedding photography in the Bay Area"
            {...register("tagline")}
          />
          {errors.tagline && (
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            placeholder="A few sentences about your business — shown on your public page."

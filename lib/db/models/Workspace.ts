...
const workspaceSchema = new Schema(
  {
    ...
    publicPage: {
      ...
      header: {
        ...
        inactiveLinkBackgroundColor: { type: String, default: "" },
        inactiveLinkOpacity: { type: Number, default: 100 },
        inactiveLinkBorderWidth: { type: Number, default: 0 },
        inactiveLinkBorderColor: { type: String, default: "" },
        inactiveLinkRadius: { type: String, enum: [...BRAND_KIT_RADII, ""], default: "" },
        activeLinkColor: { type: String, default: "" },
        activeLinkBackgroundColor: { type: String, default: "" },
        activeLinkOpacity: { type: Number, default: 100 },
        activeLinkBorderWidth: { type: Number, default: 0 },
        activeLinkBorderColor: { type: String, default: "" },

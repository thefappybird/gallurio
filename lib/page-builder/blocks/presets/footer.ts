...
import { accentBandSection, child, onPrimaryBand, pageSection, primaryBandSection, slot } from "./_helpers";
...
export const FOOTER_DIRECTORY_PRESET: FooterPresetProps = {
  ...
  content: slot([
    ...
    child("Container", {
      ...
      _style: { paddingTop: "0px", paddingRight: "0px", paddingBottom: "0px", paddingLeft: "0px" },
      content: slot([child("Columns", {
        columns: 3,
        overallWidth: "full",
        minHeight: "0px",
        _style: { gap: 40 },
    ...
    child("Container", {
      overallWidth: "page-fit",
      _style: { contentHorizontalAlign: "start", paddingTop: "0px", paddingRight: "0px", paddingBottom: "0px", paddingLeft: "0px" },

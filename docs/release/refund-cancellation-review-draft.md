...
**Refund contact:** `[billing/support email]`

## 1. Free access and beta promo

The standard new-workspace Pro access period is one month at no charge, with no
card required. The two-month beta participant promo is also a promotional grant
and is not a payment for which a refund is owed. It may be redeemed once by a
verified beta participant and expires two months after redemption.
...
The current lifecycle sends the expiry notice at T0, a saved-data reminder at
T+30 days, a final public-page warning at T+51 days, and unpublishes the public
page at T+58 days. Workspace data, CRM data, and drafts remain retained for
...
Unless required by law or approved under the applicable process, refunds may
not be available for unused time after cancellation, failure to cancel before
renewal, temporary non-use, or a change of mind after substantial use.

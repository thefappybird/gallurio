...
- Lemon Squeezy (Merchant of Record) handles subscriptions; Vercel Workflow DevKit handles the durable checkout wait on webhook confirmation. Pre-launch, `LEMONSQUEEZY_TEST_MODE` keeps the app in test mode.
